...
iptables -t filter -I INPUT 2 -s x.x.x.x/x -i eth0 -m policy --pol ipsec --dir in --protocol tcp --dport 22 -j ACCEPT
iptables -t filter -I INPUT 3 -i eth0 -m tcp --protocol tcp --dport 22 -j DROP
